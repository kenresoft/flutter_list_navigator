...
class Formulas {
  ...
  /// Then, it calculates the width of the list view using the `size` / `this.listWidth` formula.
  /// If the listWidth is less than 1,
  /// then the width of the list view is set to the size of the screen.
  /// If the listWidth is greater than the size of the screen,
  /// then the width of the list view is set to the size of the screen.
  ///
  ...
  /// Calculates the width of each item in the list view.
  ///
  ...
  /// Calculates the width of the divider between items in the list view.
  ///
  /// Returns the calculated width.
  ///
  /// Example:
  ...
  /// Calculates the width of the divider between columns in the list view.
  ///
  /// Returns the calculated width.
  ///
  /// Example:
